                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#collapsePackage" aria-expanded="false" aria-controls="collapseLayouts">
                                <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                                HolidayPackages
                                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                            </a>
                            <div class="collapse" id="collapsePackage" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="{{ url('admin/add-holidaycategory') }}">Add HolidayCategory</a>
                                    <a class="nav-link" href="{{ url('admin/holidaycategory') }}">HolidayCategory</a>
                                    <a class="nav-link" href="{{ url('admin/add-holidaypackages') }}">Add packages</a>
                                    <a class="nav-link" href="{{ url('admin/packages') }}">Packages</a>
                                    <a class="nav-link" href="{{ url('admin/contries') }}">Countries</a>
                                    <a class="nav-link" href="{{ url('admin/cities') }}">Cities</a>
                                    <a class="nav-link" href="{{ url('admin/amenities') }}">Amenities</a>
                                </nav>
                            </div>
